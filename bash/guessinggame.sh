...
while [ -z $userguess ]; do
  read -p "There was no response. Please enter a number from 1 to 10: " userguess
done

while [ $userguess -gt 10 -o $userguess -lt 1 ]; do
  read -p "That was outside the range; please enter a number between 1 to 10: " userguess
done
